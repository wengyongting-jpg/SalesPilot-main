...
from ..domain.enums import Qualification, ReplyMode
...
class ConversationService:
    ...
    def handle_customer_message(
        ...
        *,
        ...
        result = ConversationResult(
            ...
            case=verdict.case,
            quick_replies=verdict.quick_replies,
    ...
    def _run_kernel(
        ...
        *,
        ...
        return KernelVerdict(
            ...
            customer_facts=self._facts_for(action, retrieval),
        )
    ...
    @staticmethod
    def _facts_for(action: NextBestAction, retrieval: RetrievalResult) -> list[str]:
