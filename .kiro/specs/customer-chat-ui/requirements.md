...
> see `docs/backend-contract.md` Part B item 5.
...
> governs and the feature is invisible. See `docs/backend-contract.md` Part B
> item 2.
...
5. WHEN the `salespilot` adapter receives a response missing an optional field
   defined in `docs/backend-contract.md` Part B THE SYSTEM SHALL continue
