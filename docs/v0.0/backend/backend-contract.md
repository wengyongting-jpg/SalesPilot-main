...
> **[`docs/v0.0/api/interface-v1.md`](../api/interface-v1.md)**, a shared file both tracks
> edit. Where that file and this one disagree about a shape, **that file wins**.
>
> Read in this order:
> 1. **[`docs/v0.0/backend/backend-handoff.md`](backend-handoff.md)** — ownership, priorities,
>    what must not change.
> 2. **[`docs/v0.0/api/interface-v1.md`](../api/interface-v1.md)** — the contract, the
...
- **Part A — the frozen build's API. Historical.** It describes `salespilot/`, not what
  ...
  **[`docs/v0.0/api/interface-v1.md`](../api/interface-v1.md) §5**, which is frozen as of
...
Specified in `docs/v0.0/api/interface-v1.md` §2 and §5.1.
...
Specified in `docs/v0.0/api/interface-v1.md` §1.2 and §5.2.
...
Specified in `docs/v0.0/api/interface-v1.md` §5.3, which carries the full payload
shape.
...
Specified in `docs/v0.0/api/interface-v1.md` §1.1.
...
Specified in `docs/v0.0/api/interface-v1.md` §5.7.
...
Specified in `docs/v0.0/api/interface-v1.md` §1.2 and §5.8.
...
`docs/v0.0/api/interface-v1.md` §5.6 proposes an incremental cursor for the **customer**
...
`docs/v0.0/backend/backend-plan.md` §9 under P2.
...
planned for it. The reasoning is in `docs/v0.0/backend/backend-plan.md` §2: the frontend has
