...
| **Companions** | `docs/v0.0/api/interface-v1.md` (shared contract) · `docs/v0.0/backend/backend-contract.md` (gap register) · `docs/v0.0/backend/backend-handoff.md` (ownership) · `docs/v0.0/backend/backend-changelog.md` (gated record) |
...
✔ `docs/v0.0/backend/backend-changelog.md` entry for P3–P7 written, on authorisation.
...
- Authentication. Unchanged decision, recorded in `interface-v1.md` §2 and
  `docs/v0.0/product/product.md`. No fake login.
