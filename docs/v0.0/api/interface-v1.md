...
| **Supersedes** | `docs/v0.0/backend/backend-contract.md` Part A (the schema reference) |
| **Companions** | `docs/v0.0/backend/backend-contract.md` (gap register) · `docs/v0.0/backend/backend-handoff.md` (ownership and coordination) |
...
`models.py` as of the 2026-09-22 backend refactor (see `docs/v0.0/backend/backend-changelog.md`).
...
resolve. Each item has a corresponding entry in `docs/v0.0/backend/backend-contract.md`
...
Unchanged from `docs/v0.0/backend/backend-contract.md` Part B item 2. At most three, labels at
...
label the assistant as AI (`docs/v0.0/product/product.md`) still applies. What changed
