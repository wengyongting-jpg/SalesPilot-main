...
Related: `docs/v0.0/api/interface-v1.md` (contract, naming rules, visibility tiers,
topology) · `docs/v0.0/backend/backend-contract.md` (gap register) · `design.md` · `tasks.md` ·
`docs/v0.0/conventions/frontend-conventions.md` · customer design tokens in
`docs/v0.0/frontend/customer-chat-ui/ux-spec.md`.
...
6. WHEN a capability defined in `docs/v0.0/backend/backend-contract.md` is unavailable THE
