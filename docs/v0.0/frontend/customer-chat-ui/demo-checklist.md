...
- [ ] Any newly discovered backend gap is recorded in `docs/v0.0/backend/backend-contract.md`.
- [ ] `docs/v0.0/frontend/frontend-changelog.md` is unchanged unless an entry was explicitly
      authorised.
...
- There is no authentication. Any client can claim any `customer_id` and read that
  conversation. Accepted for the demo; recorded in `docs/v0.0/backend/backend-contract.md`.
