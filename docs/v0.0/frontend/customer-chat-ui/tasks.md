...
- `docs/v0.0/backend/backend-contract.md` updated if any new gap was discovered.
- `docs/v0.0/frontend/frontend-changelog.md` left untouched unless the owner has explicitly
  authorised an entry.
