...
**快速导航**:
- 过期测试清单: `deprecated-tests.md`（原文件未随仓库保留）
- 测试失败分析: `test-failure-analysis.md`（原文件未随仓库保留）
...
**文件清单**:
- ⚠️ 冲突: `docs/v0.0/api/interface-v1.md`
- ✅ Kevin-work: `docs/v0.0/api/interface-v2.md` (新增)
...
**文件清单**:
- ⚠️ 冲突: `docs/v0.0/backend/backend-changelog.md`
- ⚠️ 冲突: `docs/v0.0/backend/backend-contract.md`
- ⚠️ 冲突: `docs/v0.0/backend/backend-handoff.md`
- ⚠️ 冲突: `docs/v0.0/backend/backend-plan.md`
...
**文件清单**:
- ⚠️ 冲突: `docs/v0.0/frontend/frontend-changelog.md`
- `frontend/README.md`
...
- [ ] `docs/v0.0/backend/backend-contract.md` - 接口定义
...
**文档** (1 个文件):
1. `docs/v0.0/history/merge-plan.md` - 完整的合并计划和进度
